package com.rsstudio.networkcalling.adapter
...
import com.rsstudio.networkcalling.util.CommonUtil

class MainAdapter(
    private var context: Context
) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    var list: MutableList<BeerInfoNetworkEntity> = mutableListOf()
    ...
    inner class ItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun onBind(item: BeerInfoNetworkEntity) {
    ...
    fun submitList(newList: List<BeerInfoNetworkEntity>) {
        list.clear()
        list.addAll(newList)
